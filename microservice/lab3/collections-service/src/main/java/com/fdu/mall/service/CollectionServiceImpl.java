...
public class CollectionServiceImpl implements CollectionService{
    ...
    @Override
    public int addcollection(String buyer, Integer goodsId,Integer num,String specName,String img,String name,String seller,Integer price ){
        /*
        ...
        http.disconnect();
        collectionmapper.addToCollection(username, goodsId, item.getInt("num"), item.getString("specName"), item.getString("img"), item.getString("name"), "seller1", item.getInt("price"));
        return 0;

         */
        return  collectionmapper.addToCollection(buyer, goodsId,num,specName,img,name, seller,price);
