...
public class OrdersController {
    ...
    public Result buyNow(@RequestBody Map map) throws IOException {
        String buyer = (String) map.get("username");
        ...
        //调用查询商品信息接口
//        URL url = new URL("http://product-service:8100/api/mall/goods/getGoodsInfo");
...
//        设置请求参数
        ...
        //调用查询用户信息接口
//        URL url1 = new URL("http://user-service:8090/api/mall/order/userInfo");
...
//        http1.disconnect();
        ...
        String url1="http://user-service/api/mall/user/userInfo/"+buyer;
        ...
        int i = 1;
        i = OrdersService.buyNow(buyer, goodsId, num, specName, name, img, price, seller, orders_id_max, suborders_id_max, phone, address);
