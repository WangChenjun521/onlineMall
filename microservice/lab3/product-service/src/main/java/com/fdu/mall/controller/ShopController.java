...
//前台接口
    ...
    public Result getGoodsInfo_front(@RequestBody Map map ){
     //   Integer goodsId = (Integer) map.get("goodsId");
       ...
       GetProductInfoVo product = shopService.getGoodsInfo_front(Integer.parseInt(map.get("goodsId").toString()));
      //  GetProductInfoVo product = shopService.getGoodsInfo_front(goodsId);
